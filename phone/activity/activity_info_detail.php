...
if(isset($_POST["activity_id"]))
{
  ...
  if(mysql_num_rows($result)>0)
  {
    ...
    foreach($datas as $key =>$rows)
    {
        ...
        echo "y,$aid,$aphoto,$aname,$pname,$location,$aclass,$last_ticket,$unit1,$unit2,$sdate,$edate,$stime,$etime,$init_date,$init_user,$init_photo,$content,$tag1,$tag2,$tag3,$start_ticket";
