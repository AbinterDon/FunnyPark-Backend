...
<?php
  ...
  //接收表單資訊
  $cid=@$_POST["crp1"];
  $result=mysql_query("SELECT * FROM `activity_classification` WHERE activity_cid=$cid"); //尋找該活動資料
           ...
           ?>
            ...
            <div class="input-field col s12">
              <i class="material-icons prefix">style</i>
                <input name="cname" id="icon_cname" type="text" value="<?php echo $datas[0]['activity_cname'];?>" class="validate" required>
