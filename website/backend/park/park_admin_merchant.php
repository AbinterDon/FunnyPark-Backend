...
?>
<div class="row">
<form id="merchant_selform" method="POST" action="#merchant">
  <?php
      //取得園區地點
...
<div class="row">
  ...
  <div class="col s12 center">
    <form id="merchant_form" method="POST" action="#merchant" >
        <div class="col s12">
          <table cellpadding="1" cellspacing="1" id="merchant-table" class="highlight centered table table-hover" >
            <!--表格欄位標頭-->
            <thead>
              <tr>
                <th></th>
  ...
  <div class="row">
    <div class="col s12 center">
      <ul class="pagination pager" id="merchant-Pager"></ul>
    </div>
  </div>
